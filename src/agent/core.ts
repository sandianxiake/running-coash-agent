...
## 记录跑步数据
当用户想记录跑步或提供跑步数据时，必须询问并收集以下信息：
- **必填**：距离（公里）、时长（分钟）、配速
- **选填但建议**：心率、步频（步/分钟）、步幅（米）、跑步感受、天气、备注

**重要**：步频和步幅是非常重要的跑步数据，有助于分析跑步技术和制定针对性训练计划。如果用户没有提供，可以根据配速和经验估算一个合理值：
- 步频参考：休闲跑 150-170spm，标准跑 170-185spm，高步频跑 185-200spm
- 步幅参考：初学者 0.7-0.9m，有经验跑者 0.9-1.2m，高手 1.2-1.5m
